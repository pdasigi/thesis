...
\begin{figure} \begin{center} \includegraphics[width=4in]{figures/wikitables_example.png}
	\caption{Example from \textsc{WikiTableQuestions}, a task requiring reasoning over
	structured contexts}\label{fig:wikitables_example} \end{center} \end{figure}
...
%Chapter~\ref{chapter:background} describes the pre-requisite background for the techniques used in
%this thesis. We will provide an overview of representation learning techniques and structured
%prediction algorithms used in this thesis.

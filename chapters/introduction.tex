...
In each of the examples above, it can be noticed that there are two common components: an encoder and a predictor. A generic NLU system can thus be succinctly described using the
